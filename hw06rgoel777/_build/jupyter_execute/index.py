...
ut.plott(make_plots, strain_L1_whitenbp, strain_H1_whitenbp, template_match, time, timemax, SNR, tevent, eventname, plottype, template_fft, d_eff, freqs, data_psd, datafreq, fs, det)
